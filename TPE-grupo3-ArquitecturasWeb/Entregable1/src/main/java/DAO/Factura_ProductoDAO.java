...
public class Factura_ProductoDAO {
    ...
    private static Factura_ProductoDAO instancia;

    private Factura_ProductoDAO(Connection conn) {
        this.conn = conn;
    }
    ...
    public static Factura_ProductoDAO getInstancia(Connection conn) {
        if (instancia == null) {
            instancia = new Factura_ProductoDAO(conn);
        }
